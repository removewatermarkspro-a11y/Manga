...
const funMessages = [
    ...
    "Building the narrative arc for your pages... 🎬",
    "Adding dramatic twists and turns... 🌪️",
    "Sketching the first pages... ✏️",
    ...
    "Creating speech bubbles and dialogue... 💬",
    "Adding final touches to each page... 🎭",
    "Almost there! Just a few more pages... 🔥",
...
export default function LoadingPopup({ isOpen, selectedStyle, onComplete, autoClose = true }: LoadingPopupProps) {
    ...
    const getStyleMessage = () => {
        switch (selectedStyle) {
            case 'manga': return 'Your Manga is being created...';
            case 'comic': return 'Your Comic Book is being created...';
            case 'manhwa': return 'Your Manhwa is being created...';
            default: return 'Your story is being created...';
        }
    };
                        ...
                        <div className="bg-white border-[4px] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-2xl max-w-md w-full p-8">
                            <div className="flex flex-col items-center gap-5">
                                ...
                                <div className="text-center space-y-1">
                                    <h2 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] font-display uppercase tracking-wider">
                                        Creating Magic ✨
                                    </h2>
                                ...
                                {!autoClose && (
                                    <div className="bg-white border-[3px] border-black rounded-xl px-4 py-3 w-full text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                                        <p className="text-sm font-black text-black">
                                            ⏱️ Estimated time: <span className="text-[#6366f1]">2 to 4 minutes</span>
                                        </p>
                                ...
                                <div className="w-full">
                                    <div className="w-full h-4 bg-gray-200 border-[2px] border-black rounded-full overflow-hidden">
                                        <div
                                            ...
                                            className="h-full bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] rounded-full transition-all duration-200"
                                        />
                                    </div>
                                    <p className="text-center text-sm font-black text-gray-600 mt-2">
                                        {Math.round(progress)}%
                                    </p>
                                </div>
                                ...
                                <AnimatePresence mode="wait">
                                    <motion.p
                                        ...
                                        className="text-sm text-gray-500 text-center italic font-bold min-h-[20px]"
                                    >
                                ...
                                {!autoClose && (
                                    <div className="bg-[#facc15] border-[2px] border-black rounded-lg px-3 py-2 w-full text-center">
